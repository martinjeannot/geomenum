...
package com.geomenum.web.domainmodel;
...
import com.geomenum.web.serialization.InputStreamSerializer;
import com.geomenum.web.serialization.URIDeserializer;
...
public class WebDomainModelMapper {
    ...
    static {
        ...
        SimpleModule webModule = new SimpleModule();

        // input streams are currently serialized as byte arrays
        webModule.addSerializer(InputStream.class, new InputStreamSerializer());

        webModule.addDeserializer(URI.class, new URIDeserializer(SpringApplicationContext.getBean(StaticResourcesResolver.class)));

        OBJECT_MAPPER.registerModule(webModule);
